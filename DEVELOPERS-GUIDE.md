...
### Usable URLs ###
  ...
  - **API** - http://localhost:6969/test
  - **DB Interface** - http://localhost:6969/dbshell
  - **Java Class Browser** - http://localhost:6969/doc
...
### Testing ###
  ...
  - all API calls can be tested manually from the auto-generated http://localhost:6969/test page
